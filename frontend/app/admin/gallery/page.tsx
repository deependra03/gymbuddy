    ...
    <div className="page-container">
      ...
      {loading ? (
        ...
        <div className="card text-center py-16">
          ...
          <p className="text-zinc-400 font-medium">Gallery is empty</p>
        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto animate-slide-up">
            <div className="sticky top-0 bg-zinc-900 flex items-center justify-between p-6 border-b border-zinc-800">
              <h2 className="text-lg font-bold">{editing ? 'Edit Gallery Item' : 'Add to Gallery'}</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  {imageUrl ? (
                    <img src={imageUrl} className="w-20 h-16 rounded-xl object-cover bg-zinc-800" />
                  ) : (
                    <div className="w-20 h-16 rounded-xl bg-zinc-800 flex items-center justify-center">
...
function GalleryCard({
  ...
  return (
    <div className="card hover:border-zinc-700 transition-colors group overflow-hidden">
